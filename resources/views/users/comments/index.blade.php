...
@section('content')
<h1 class="text-2xl font-semibold leading-tigh py-2">Comentários do Usuário {{ $user->name }}
...
<table class="min-w-full leading-normal shadow-md rounded-lg overflow-hidden">
    ...
    <tr>
        ...
        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ $commnet->visible }}</td>
